...
const CodecTag codec_bmp_tags[] = {
    { CODEC_ID_H264, MKTAG('H', '2', '6', '4'),0 },

    { CODEC_ID_H263, MKTAG('H', '2', '6', '3'),0 },
    { CODEC_ID_H263P, MKTAG('H', '2', '6', '3'),0 },
    { CODEC_ID_H263I, MKTAG('I', '2', '6', '3'),0 }, /* intel h263 */

    /* added based on MPlayer */
    { CODEC_ID_H263P, MKTAG('U', '2', '6', '3'),0 },
    { CODEC_ID_H263P, MKTAG('v', 'i', 'v', '1'),0 },

    { CODEC_ID_MPEG4, MKTAG('D', 'I', 'V', 'X'), 1 },
    { CODEC_ID_MPEG4, MKTAG('D', 'X', '5', '0'), 1 },
    { CODEC_ID_MPEG4, MKTAG('X', 'V', 'I', 'D'), 1 },
    { CODEC_ID_MPEG4, MKTAG('M', 'P', '4', 'S'), 0 },
    { CODEC_ID_MPEG4, MKTAG('M', '4', 'S', '2'), 0 },
    { CODEC_ID_MPEG4, MKTAG(0x04, 0, 0, 0), 0 }, /* some broken avi use this */

    /* added based on MPlayer */
    { CODEC_ID_MPEG4, MKTAG('D', 'I', 'V', '1'), 0 },
    { CODEC_ID_MPEG4, MKTAG('B', 'L', 'Z', '0'), 0 },
    { CODEC_ID_MPEG4, MKTAG('m', 'p', '4', 'v'), 0 },
    { CODEC_ID_MPEG4, MKTAG('U', 'M', 'P', '4'), 0 },

    { CODEC_ID_MSMPEG4V3, MKTAG('D', 'I', 'V', '3'), 1 }, /* default signature when using MSMPEG4 */
    { CODEC_ID_MSMPEG4V3, MKTAG('M', 'P', '4', '3'), 1 }, 

    /* added based on MPlayer */
    { CODEC_ID_MSMPEG4V3, MKTAG('M', 'P', 'G', '3'),0 }, 
    { CODEC_ID_MSMPEG4V3, MKTAG('D', 'I', 'V', '5'),0 }, 
    { CODEC_ID_MSMPEG4V3, MKTAG('D', 'I', 'V', '6'),0 }, 
    { CODEC_ID_MSMPEG4V3, MKTAG('D', 'I', 'V', '4'),0 }, 
    { CODEC_ID_MSMPEG4V3, MKTAG('A', 'P', '4', '1'),0 }, 
    { CODEC_ID_MSMPEG4V3, MKTAG('C', 'O', 'L', '1'),0 }, 
    { CODEC_ID_MSMPEG4V3, MKTAG('C', 'O', 'L', '0'),0 }, 

    { CODEC_ID_MSMPEG4V2, MKTAG('M', 'P', '4', '2'),0 }, 

    /* added based on MPlayer */
    { CODEC_ID_MSMPEG4V2, MKTAG('D', 'I', 'V', '2'),0 },
 
    { CODEC_ID_MSMPEG4V1, MKTAG('M', 'P', 'G', '4'),0 }, 

    { CODEC_ID_WMV1, MKTAG('W', 'M', 'V', '1'),0 }, 

    /* added based on MPlayer */
    { CODEC_ID_WMV2, MKTAG('W', 'M', 'V', '2'),0 }, 
    { CODEC_ID_DVVIDEO, MKTAG('d', 'v', 's', 'd'),0 }, 
    { CODEC_ID_DVVIDEO, MKTAG('d', 'v', 'h', 'd'),0 }, 
    { CODEC_ID_DVVIDEO, MKTAG('d', 'v', 's', 'l'),0 }, 
    { CODEC_ID_DVVIDEO, MKTAG('d', 'v', '2', '5'),0 },
    { CODEC_ID_MPEG1VIDEO, MKTAG('m', 'p', 'g', '1'),0 }, 
    { CODEC_ID_MPEG1VIDEO, MKTAG('m', 'p', 'g', '2'),0 }, 
    { CODEC_ID_MPEG2VIDEO, MKTAG('m', 'p', 'g', '2'),0}, 
    { CODEC_ID_MPEG1VIDEO, MKTAG('P', 'I', 'M', '1'),0 }, 
    { CODEC_ID_MPEG1VIDEO, MKTAG('V', 'C', 'R', '2'),0 }, 
    { CODEC_ID_MPEG1VIDEO, 0x10000001,0 }, 
    { CODEC_ID_MPEG2VIDEO, 0x10000002,0 }, 
    { CODEC_ID_MJPEG, MKTAG('M', 'J', 'P', 'G'),0 },
    { CODEC_ID_MJPEG, MKTAG('L', 'J', 'P', 'G'),0 },
    { CODEC_ID_LJPEG, MKTAG('L', 'J', 'P', 'G'),0 },
    { CODEC_ID_MJPEG, MKTAG('J', 'P', 'G', 'L'),0 }, /* Pegasus lossless JPEG */
    { CODEC_ID_HUFFYUV, MKTAG('H', 'F', 'Y', 'U'),0 },
    { CODEC_ID_CYUV, MKTAG('C', 'Y', 'U', 'V'),0 },
    { CODEC_ID_RAWVIDEO, MKTAG('Y', '4', '2', '2'),0 },
    { CODEC_ID_RAWVIDEO, MKTAG('I', '4', '2', '0'),0 },
    { CODEC_ID_INDEO3, MKTAG('I', 'V', '3', '1'),0 },
    { CODEC_ID_INDEO3, MKTAG('I', 'V', '3', '2'),0 },
    { CODEC_ID_VP3, MKTAG('V', 'P', '3', '1'),0 },
    { CODEC_ID_ASV1, MKTAG('A', 'S', 'V', '1'),0 },
    { CODEC_ID_ASV2, MKTAG('A', 'S', 'V', '2'),0 },
    { CODEC_ID_VCR1, MKTAG('V', 'C', 'R', '1'),0 },
    { CODEC_ID_FFV1, MKTAG('F', 'F', 'V', '1'),0 },
    { CODEC_ID_XAN_WC4, MKTAG('X', 'x', 'a', 'n'),0 },
    { CODEC_ID_MSRLE, MKTAG('m', 'r', 'l', 'e'),0 },
    { CODEC_ID_MSRLE, MKTAG(0x1, 0x0, 0x0, 0x0),0 },
    { CODEC_ID_MSVIDEO1, MKTAG('M', 'S', 'V', 'C'),0 },
    { CODEC_ID_MSVIDEO1, MKTAG('m', 's', 'v', 'c'),0 },
    { CODEC_ID_MSVIDEO1, MKTAG('C', 'R', 'A', 'M'),0 },
    { CODEC_ID_MSVIDEO1, MKTAG('c', 'r', 'a', 'm'),0 },
    { CODEC_ID_MSVIDEO1, MKTAG('W', 'H', 'A', 'M'),0 },
    { CODEC_ID_MSVIDEO1, MKTAG('w', 'h', 'a', 'm'),0 },
    { CODEC_ID_CINEPAK, MKTAG('c', 'v', 'i', 'd'),0 },
    { CODEC_ID_TRUEMOTION1, MKTAG('D', 'U', 'C', 'K'),0 },
    { CODEC_ID_MSZH, MKTAG('M', 'S', 'Z', 'H'),0 },
    { CODEC_ID_ZLIB, MKTAG('Z', 'L', 'I', 'B'),0 },
    { CODEC_ID_4XM, MKTAG('4', 'X', 'M', 'V'),0 },
    { CODEC_ID_FLV1, MKTAG('F', 'L', 'V', '1'),0 },
    { CODEC_ID_SVQ1, MKTAG('s', 'v', 'q', '1'),0 },
    { 0, 0 },
};
