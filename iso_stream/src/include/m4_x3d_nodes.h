...
#ifndef _M4_X3D_NODES_H
#define _M4_X3D_NODES_H
...
enum {
	TAG_X3D_Anchor = TAG_RANGE_FIRST_X3D,
	TAG_X3D_Appearance,
	TAG_X3D_Arc2D,
	TAG_X3D_ArcClose2D,
	TAG_X3D_AudioClip,
...
typedef struct _tagX3DAppearance
{
	...
	SFNode *fillProperties;	/*exposedField*/
	SFNode *lineProperties;	/*exposedField*/
	SFNode *metadata;	/*exposedField*/
} X_Appearance;
...
typedef struct _tagX3DBooleanFilter
{
	...
	void (*on_set_boolean)(SFNode *pThis);	/*eventInHandler*/
...
typedef struct _tagX3DBooleanSequencer
{
	BASE_NODE
	SFBool next;	/*eventIn*/
	void (*on_next)(SFNode *pThis);	/*eventInHandler*/
	SFBool previous;	/*eventIn*/
	void (*on_previous)(SFNode *pThis);	/*eventInHandler*/
...
typedef struct _tagX3DBooleanTrigger
{
	...
	void (*on_set_triggerTime)(SFNode *pThis);	/*eventInHandler*/
...
typedef struct _tagX3DIndexedTriangleFanSet
{
	...
	void (*on_set_index)(SFNode *pThis);	/*eventInHandler*/
	SFNode *color;	/*exposedField*/
	SFNode *coord;	/*exposedField*/
	SFNode *normal;	/*exposedField*/
	SFNode *texCoord;	/*exposedField*/
...
{
	BASE_NODE
	Chain *texCoord;	/*MultiTextureCoordinate*/
	SFNode *metadata;	/*exposedField*/
...
{
	BASE_NODE
	Chain *textureTransform;	/*exposedField*/
	SFNode *metadata;	/*exposedField*/
...
typedef struct _tagX3DTextureBackground
{
	...
	MFFloat groundAngle;	/*exposedField*/
	MFColor groundColor;	/*exposedField*/
	SFNode *backTexture;	/*exposedField*/
	SFNode *bottomTexture;	/*exposedField*/
	SFNode *frontTexture;	/*exposedField*/
	SFNode *leftTexture;	/*exposedField*/
	SFNode *rightTexture;	/*exposedField*/
	SFNode *topTexture;	/*exposedField*/
	MFFloat skyAngle;	/*exposedField*/
	MFColor skyColor;	/*exposedField*/
